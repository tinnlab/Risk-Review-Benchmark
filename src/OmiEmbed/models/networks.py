...
class FCBlock(nn.Module):
    ...
    # I change normalization="False" because cuDNN + batchnorm has error ''cuDNN error: CUDNN_STATUS_EXECUTION_FAILED''

    def __init__(self, input_dim, output_dim, norm_layer=nn.BatchNorm1d, leaky_slope=0.2, dropout_p=0, activation=True, normalization=False, activation_name='LeakyReLU'):
        """
...
def init_net(net, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    """
    # uncomment below lines for original code
    if len(gpu_ids) > 0:
