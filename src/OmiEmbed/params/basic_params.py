...
class BasicParams:
    ...
    def initialize(self, parser):
        ...
        """
        ### add some argument to identify the dataset and seed
        ...
        parser.add_argument('--data_root', type=str, default='./TCGA-data',
        ...
        parser.add_argument('--model', type=str, default='vae_survival',
                            help='chooses which model want to use, options: [vae_classifier | vae_regression | vae_survival | vae_multitask]')
